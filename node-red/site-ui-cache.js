...
if (['nav/arrived','nav/cancelled','nav/error'].includes(topic)) delete cache['nav/progress'];
const allowed = ['battery','poi','status','robotName','wifi','robot/error','estop','estop/status','config/pages','config/robot','config/conn','fleet/job-progress','ui/page','wait/start','poi/waiting','nav/progress'];
