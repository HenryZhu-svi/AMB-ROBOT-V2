...
const allowed = ['battery','poi','status','robotName','wifi','robot/error','error/status','alarm/status','estop','estop/status','config/pages','config/robot','config/conn','fleet/job-progress','ui/page','wait/start','poi/waiting','nav/progress','destination'];
