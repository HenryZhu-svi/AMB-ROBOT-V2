...
fail=true;
assert.equal(call('ui/settings/save',{revision:1,section:'standby',values:{standbyPoint:'P1'}}).topic,'ui/settings/error');
assert.equal(call('ui/settings/request').payload.revision,1);
globals.delete('fs');
